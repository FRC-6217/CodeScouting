...
<html>
    ...
    <h2>
          <center><a href="https://geminimade.com/" target="_blank"><img class="image10" src="Sponsors/Gemini.jpg" style="max-width: 18%"></a>
		  <p></p><a id="mainpage" class="clickme danger" href="sponsors6217.php">All Sponsors</a>
		</center>
          <p></p>
     </h2>
	    <h2><center>
