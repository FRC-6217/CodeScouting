<html>
	...
	<head>
		...
		<form enctype="multipart/form-data" action='coopertitionLogConf6217.php' method='post'>
<?php
	...
	$coopertitionLogId = "$_GET[coopertitionLogId]";
?>
			<center>				
				<div class="container" id="log">
					<?php
					echo '<input type="hidden" id="coopertitionLogId" name="coopertitionLogId" value="' . $coopertitionLogId . '">'; 
					$tsql = "select fName
								  , fLabel
								  , fSort
								  , fLogHtml
