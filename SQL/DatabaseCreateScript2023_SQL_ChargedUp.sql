...
insert into Objective select g.id, 'aCoLow', 'Cone Low:', st.id, 0, 3, 3, 2, getdate(), 'aCoLow', 'I', 'N', 'N', 4 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Integer'
insert into Objective select g.id, 'aCoMid', 'Mid:', st.id, 0, 3, 4, 3, getdate(), 'aCoMid', 'I', 'Y', 'N', 5 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Integer'
insert into Objective select g.id, 'aCoHi', 'Hi:', st.id, 0, 3, 6, 4, getdate(), 'aCoHi', 'I', 'Y', 'N', 6 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Integer'
insert into Objective select g.id, 'aCuLow', 'Cube Low:', st.id, 0, 3, 3, 5, getdate(), 'aCuLow', 'I', 'N', 'N', 7 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Integer'
insert into Objective select g.id, 'aCuMid', 'Mid:', st.id, 0, 2, 4, 6, getdate(), 'aCuMid', 'I', 'Y', 'N', 8 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Integer'
insert into Objective select g.id, 'aCuHi', 'Hi:', st.id, 0, 2, 6, 7, getdate(), 'aCuHi', 'I', 'Y', 'N', 9 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Integer'
insert into Objective select g.id, 'toCoLow', 'Cone Low:', st.id, 0, 9, 2, 8, getdate(), 'toCoLow', 'I', 'N', 'N', 10 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Integer'
insert into Objective select g.id, 'toCoMid', 'Mid:', st.id, 0, 6, 3, 9, getdate(), 'toCoMid', 'I', 'Y', 'N', 11 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Integer'
insert into Objective select g.id, 'toCoHi', 'Hi:', st.id, 0, 6, 5, 10, getdate(), 'toCoHi', 'I', 'Y', 'N', 12 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Integer'
insert into Objective select g.id, 'toCuLow', 'Cube Low:', st.id, 0, 9, 2, 11, getdate(), 'toCuLow', 'I', 'N', 'N', 13 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Integer'
insert into Objective select g.id, 'toCuMid', 'Mid:', st.id, 0, 3, 3, 12, getdate(), 'toCuMid', 'I', 'Y', 'N', 14 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Integer'
insert into Objective select g.id, 'toCuHi', 'Hi:', st.id, 0, 3, 5, 13, getdate(), 'toCuHi', 'I', 'Y', 'N', 15 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Integer'
insert into Objective select g.id, 'toDefense', 'Defense:', st.id, null, null, null, 14, getdate(), 'Def', 'I', 'N', 'N', 18 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Radio Button'
insert into Objective select g.id, 'toHP', 'Human Player Perf:', st.id, null, null, null, 15, getdate(), 'HP', 'I', 'N', 'N', 19 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Radio Button'
...
insert into Objective select g.id, 'toEnd', 'End Game:', st.id, null, null, null, 18, getdate(), 'End', 'S', 'N', 'N', 17 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Radio Button'
insert into Objective select g.id, 'links', 'Links:', st.id, 0, 9, 5, 19, getdate(), 'Links', 'S', 'N', 'Y', 16 from Game g, ScoringType st where g.name = 'Charged Up' and st.name = 'Integer'
...
insert into Rank select 'Driving', 'rankDr', 'S', 4, getdate(), g.id from Game g where g.name = 'Charged Up'
...
insert into RankObjective select r.id, o.id, getdate() from Game g inner join Objective o on o.gameId = g.id inner join Rank r on r.gameId = g.id where g.name = 'Charged Up' and o.name = 'links' and r.name = 'Scr Imp'
