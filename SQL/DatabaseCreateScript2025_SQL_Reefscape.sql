...
insert into Objective select g.id, 'aL3', 'Coral L3:', st.id, 0, 6, 6, 3, getdate(), 'aL3', 'I', 'N', 'N', 4 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Integer'
...
insert into Objective select g.id, 'toL3', 'Coral L3:', st.id, 0, 12, 4, 9, getdate(), 'toL3', 'I', 'N', 'N', 10 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Integer'
...
insert into Objective select g.id, 'toDefense', 'Defense (0=None, 1=Poor to 4=Great):', st.id, null, null, null, 15, getdate(), 'Def', 'I', 'N', 'N', 15 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Radio Button'
...
insert into Objective select g.id, 'toEnd', 'Barge:', st.id, null, null, null, 15, getdate(), 'Barge', 'S', 'N', 'N', 14 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Radio Button'
insert into Objective select g.id, 'Rating', 'How would you rate the robot (0-10)? (Gracious Professionalism):', st.id, null, null, null, 16, getdate(), 'Rate', 'I', 'N', 'N', 16 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Radio Button'
...
insert into ObjectiveGroupObjective select og.id, o.id, getdate() from Game g inner join Objective o on o.gameId = g.id, ObjectiveGroup og where g.name = 'Reefscape' and o.name = 'Rating' and og.name = 'Blue Alliance Data' and og.groupCode = 'Scout Match'
...
insert into TeamSponsor select t.id, g.id, 'Aliveo Military Museum', 0, 20, 'Sponsors/AliveoMilitaryMuseum.jpg', 'http://www.aliveomuseum.org/', 30, getdate(), null, null, 'Y' from team t, game g where t.teamNumber = 6217 and g.name = 'Reefscape';
insert into TeamSponsor select t.id, g.id, 'Hernke Heating', 0, 30, 'Sponsors/hernkes heating and cooling.png', null, 30, getdate(), null, null, 'Y' from team t, game g where t.teamNumber = 6217 and g.name = 'Reefscape';
...
insert into TeamSponsor select t.id, g.id, 'StarTech Computing', 0, 60, 'Sponsors/StarTech-logo.png', 'https://www.startech-comp.com/', 30, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Reefscape';
...
insert into TeamSponsor select t.id, g.id, 'Red Wing Area Manufacturers Association', 0, 80, 'Sponsors/RW Area Mfg Assoc.jpg', 'https://www.facebook.com/RWAreaMfrsAssoc/', 30, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Reefscape';
insert into TeamSponsor select t.id, g.id, 'Caseys', 0, 90, 'Sponsors/Casey_s.png', 'https://www.caseys.com/', 30, getdate(), null, null, 'Y' from team t, game g where t.teamNumber = 6217 and g.name = 'Reefscape';
