...
insert into Attribute select g.id, 'robotWidth', 'Width of robot (inches)?', st.id, null, null, 4, getdate(), 'Width', 'N', null from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Integer'
...
insert into Attribute select g.id, 'coralPickup', 'How does robot pickup Coral?', st.id, null, null, 6, getdate(), 'Coral', 'N', null from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Radio Button'
insert into Attribute select g.id, 'algaePickup', 'How does robot pickup Algae?', st.id, null, null, 7, getdate(), 'Algae', 'N', null from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Radio Button'
...
-- Objectives
insert into Objective select g.id, 'aLeave', 'Leave:', st.id, null, null, null, 1, getdate(), 'aLeave', 'S', 'N', 'N', 1 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Radio Button'
insert into Objective select g.id, 'aL1', 'Coral L1:', st.id, 0, 6, 3, 2, getdate(), 'aL1', 'I', 'N', 'N', 2 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Integer'
insert into Objective select g.id, 'aL2', 'L2:', st.id, 0, 6, 4, 3, getdate(), 'aL2', 'I', 'Y', 'N', 3 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Integer'
insert into Objective select g.id, 'aL3', '.......... L3:', st.id, 0, 6, 6, 4, getdate(), 'aL3', 'I', 'N', 'N', 4 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Integer'
insert into Objective select g.id, 'aL4', 'L4:', st.id, 0, 6, 7, 5, getdate(), 'aL4', 'I', 'Y', 'N', 5 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Integer'
insert into Objective select g.id, 'toL1', 'Coral L1:', st.id, 0, 12, 2, 6, getdate(), 'toL1', 'I', 'N', 'N', 6 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Integer'
insert into Objective select g.id, 'toL2', 'L2:', st.id, 0, 12, 3, 7, getdate(), 'toL2', 'I', 'Y', 'N', 7 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Integer'
insert into Objective select g.id, 'toL3', '.......... L3:', st.id, 0, 12, 4, 8, getdate(), 'toL3', 'I', 'N', 'N', 8 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Integer'
insert into Objective select g.id, 'toL4', 'L4:', st.id, 0, 12, 5, 9, getdate(), 'toL4', 'I', 'Y', 'N', 9 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Integer'
-- Only count processor shot as 2 because of human player making most of the shots. Reports are adjusted for this change.
insert into Objective select g.id, 'toProc', 'Algae Proc:', st.id, 0, 9, 2, 10, getdate(), 'toProc', 'I', 'N', 'N', 10 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Integer'
insert into Objective select g.id, 'toNet', 'Net:', st.id, 0, 18, 4, 11, getdate(), 'toNet', 'I', 'Y', 'N', 11 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Integer'
insert into Objective select g.id, 'toEnd', 'Barge:', st.id, null, null, null, 12, getdate(), 'Barge', 'S', 'N', 'N', 12 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Radio Button'
insert into Objective select g.id, 'toEGTime', 'EG Time:', st.id, 0, 45, null, 13, getdate(), 'EGTime', 'I', 'N', 'N', 13 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Integer'
insert into Objective select g.id, 'toDefense', 'Defense (0=None, 1=Poor to 4=Great):', st.id, null, null, null, 14, getdate(), 'Def', 'I', 'N', 'N', 14 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Radio Button'
insert into Objective select g.id, 'Rating', 'How would you rate the robot (0-10)? (Gracious Professionalism):', st.id, null, null, null, 15, getdate(), 'Rate', 'I', 'N', 'N', 15 from Game g, ScoringType st where g.name = 'Reefscape' and st.name = 'Radio Button'

-- Objective Group Objectives
--insert into ObjectiveGroup values ('Blue Alliance Data', 5, getdate(), 'Scout Match');
insert into ObjectiveGroupObjective select og.id, o.id, getdate() from Game g inner join Objective o on o.gameId = g.id, ObjectiveGroup og where g.name = 'Reefscape' and o.name = 'aLeave' and og.name = 'Autonomous' and og.groupCode = 'Scout Match'
...
insert into ObjectiveGroupObjective select og.id, o.id, getdate() from Game g inner join Objective o on o.gameId = g.id, ObjectiveGroup og where g.name = 'Reefscape' and o.name = 'toEnd' and og.name = 'End Game' and og.groupCode = 'Scout Match'
insert into ObjectiveGroupObjective select og.id, o.id, getdate() from Game g inner join Objective o on o.gameId = g.id, ObjectiveGroup og where g.name = 'Reefscape' and o.name = 'toEGTime' and og.name = 'End Game' and og.groupCode = 'Scout Match'
...
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Thisius', 'Christopher', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Thisius' and s.firstName = 'Christopher' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Olund', 'Greta', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Olund' and s.firstName = 'Greta' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Jandro', 'Raylan', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Jandro' and s.firstName = 'Raylan' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Merchlewitz', 'Collin', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Merchlewitz' and s.firstName = 'Collin' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Parish', 'Lucas', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Parish' and s.firstName = 'Lucas' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Stiff', 'Piper', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Stiff' and s.firstName = 'Piper' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Ramthun', 'Alek', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Ramthun' and s.firstName = 'Alek' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Miller', 'Brennan', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Miller' and s.firstName = 'Brennan' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Douglas', 'Brevon', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Douglas' and s.firstName = 'Brevon' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Newman', 'Cody-Cole', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Newman' and s.firstName = 'Cody-Cole' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Rechtzigel', 'Graham', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Rechtzigel' and s.firstName = 'Graham' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Fox', 'Solan', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Fox' and s.firstName = 'Solan' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Davisson', 'Josie', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Davisson' and s.firstName = 'Josie' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Hernke', 'Marshall', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Hernke' and s.firstName = 'Marshall' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Rapp', 'Ansel', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Rapp' and s.firstName = 'Ansel' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'VenOsdel', 'Charlie', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'VenOsdel' and s.firstName = 'Charlie' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Malloy', 'Mila', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Malloy' and s.firstName = 'Mila' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Zeman', 'Anna', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Zeman' and s.firstName = 'Anna' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Heller', 'Paisley', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Heller' and s.firstName = 'Paisley' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Homan', 'Emma', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Homan' and s.firstName = 'Emma' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Prink', 'Kathryn', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Prink' and s.firstName = 'Kathryn' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Nygaard', 'Leo', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Nygaard' and s.firstName = 'Leo' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Gesme', 'Sawyer', t.id, 'Y', 'xx@cf.k12.mn.us', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'Gesme' and s.firstName = 'Sawyer' and s.teamId = t.id);
