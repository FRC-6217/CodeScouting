...
delete from teamAttributeScouts where gameId in (select g.id from Game g where g.name = 'Rebuilt');
...
insert into Attribute select g.id, 'robotWidth', 'Width of robot (inches)?', st.id, null, null, 4, getdate(), 'Width', 'N', null from Game g, ScoringType st where g.name = 'Rebuilt' and st.name = 'Decimal'
insert into Attribute select g.id, 'robotWeight', 'Weight of robot?', st.id, null, null, 5, getdate(), 'Weight', 'N', null from Game g, ScoringType st where g.name = 'Rebuilt' and st.name = 'Decimal'
...
-- Scout
--select * from scout where teamId = 101 and isactive = 'Y' order by emailaddress, lastName, firstName
update Scout set isActive = 'N' where teamId in (select id from Team where teamNumber = 6217) and isActive <> 'N' and emailaddress not in ('cfrobotics@cf.k12.mn.us', 'golfrat7@gmail.com', 'engebret@engebret.org', 'Charlie.Stark@cf.k12.mn.us','tba@tba.com', '9149@x.com', 'thomasc31415@gmail.com', 'brandon.mcdonnell41@gmail.com', '16.jasmine.s@gmail.com', 'ghost2droid@gmail.com') and emailAddress is not null;
...
-- 3691 RoboRaiders
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Connor', 'Nick', t.id, 'Y', 'nconnor@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Connor' and s.firstName = 'Nick' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Edwards', 'Nat', t.id, 'Y', 'nedward28@gmail.com', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Edwards' and s.firstName = 'Nat' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Edwards', 'Gabe', t.id, 'Y', 'gedwar@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Edwards' and s.firstName = 'Gabe' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Forsgren', 'Vincent', t.id, 'Y', 'vforsg28@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Forsgren' and s.firstName = 'Vincent' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Heckers', 'Colby', t.id, 'Y', 'checke28@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Heckers' and s.firstName = 'Colby' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Heiman', 'Oliver', t.id, 'Y', 'oheima28@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Heiman' and s.firstName = 'Oliver' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Perkins', 'Locke', t.id, 'Y', 'lperki28@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Perkins' and s.firstName = 'Locke' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Schmelzer', 'Charles', t.id, 'Y', 'cschme28@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Schmelzer' and s.firstName = 'Charles' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Veltri', 'Micah', t.id, 'Y', 'mveltr28@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Veltri' and s.firstName = 'Micah' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Hargitay', 'Marton', t.id, 'Y', 'mhargi28@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Hargitay' and s.firstName = 'Marton' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Chatwick', 'Teagan', t.id, 'Y', 'tchatw28@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Chatwick' and s.firstName = 'Teagan' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Busch', 'Sam', t.id, 'Y', 'sbusch28@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Busch' and s.firstName = 'Sam' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Hebzynski', 'Tobias', t.id, 'Y', 'thebzy27@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Hebzynski' and s.firstName = 'Tobias' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Rein Hagen', 'Alexandre', t.id, 'Y', 'areinh27@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Rein Hagen' and s.firstName = 'Alexandre' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Hess', 'Andrew', t.id, 'Y', 'ahess26@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Hess' and s.firstName = 'Andrew' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Patton', 'Alex', t.id, 'Y', 'apatto26@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Patton' and s.firstName = 'Alex' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Do', 'Kevin', t.id, 'Y', 'kedo26@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Do' and s.firstName = 'Kevin' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Hargitay', 'Mate', t.id, 'Y', 'mhargi29@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Hargitay' and s.firstName = 'Mate' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Walker', 'Matthew', t.id, 'Y', 'mwalke29@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Walker' and s.firstName = 'Matthew' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Opatrny', 'Rodion', t.id, 'Y', 'ropatr29@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Opatrny' and s.firstName = 'Rodion' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Martinez', 'Griselda', t.id, 'Y', 'gmarti29@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Martinez' and s.firstName = 'Griselda' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Stanton', 'Owen', t.id, 'Y', 'ostant29@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Stanton' and s.firstName = 'Owen' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'McBurnett', 'Nolan', t.id, 'Y', 'nmcbur29@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'McBurnett' and s.firstName = 'Nolan' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Engelmann', 'Jacob ', t.id, 'Y', 'jengel29@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Engelmann' and s.firstName = 'Jacob ' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Thieling', 'Sam', t.id, 'Y', 'sthiel28@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Thieling' and s.firstName = 'Sam' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Greve', 'Gavin', t.id, 'Y', 'xx@northfieldschools.org', 'Y' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = 'Greve' and s.firstName = 'Gavin' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select '(Choose Scout)', '3691', t.id, 'Y', '3691@x.com', 'N' from Team t where t.teamNumber = 3691 and not exists (select 1 from Scout s where s.lastName = '(Choose Scout)' and s.firstName = '3691' and s.teamId = t.id);
update team set gameEventId = (select gameEventId from team where teamNumber = 6217) where teamNumber = 3691 and gameEventId is null
-- 2526 Crimson Robotics
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'B', 'Audrey', t.id, 'Y', 'audrey.blazevic@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'B' and s.firstName = 'Audrey' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'B', 'Ben', t.id, 'Y', 'benjaminkbecker@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'B' and s.firstName = 'Ben' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'D', 'Arrow', t.id, 'Y', 'milly.35009@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'D' and s.firstName = 'Arrow' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'D', 'Vidyut', t.id, 'Y', 'vidyutdeepak2009@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'D' and s.firstName = 'Vidyut' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'H', 'Avery', t.id, 'Y', 'averyhowe004@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'H' and s.firstName = 'Avery' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'H', 'Charlie', t.id, 'Y', 'chuynh090109@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'H' and s.firstName = 'Charlie' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'J', 'Devin', t.id, 'Y', 'devinart436@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'J' and s.firstName = 'Devin' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'K', 'Isa', t.id, 'Y', 'Isakarim620@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'K' and s.firstName = 'Isa' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'K', 'Kirill', t.id, 'Y', 'kraskaska.dev@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'K' and s.firstName = 'Kirill' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'K', 'Rachel', t.id, 'Y', 'Rkusie19@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'K' and s.firstName = 'Rachel' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'L', 'Alayna', t.id, 'Y', 'alaynal087@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'L' and s.firstName = 'Alayna' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'L', 'Ivan', t.id, 'Y', 'ilivanivan2009@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'L' and s.firstName = 'Ivan' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'M', 'Zeynab', t.id, 'Y', 'zeymamah@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'M' and s.firstName = 'Zeynab' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'N', 'Matthew', t.id, 'Y', 'Matthewnewhall1256@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'N' and s.firstName = 'Matthew' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'N', 'Travis', t.id, 'Y', 'travisgiabaonguyen@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'N' and s.firstName = 'Travis' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'R', 'Ella', t.id, 'Y', 'Ella.l.range.09@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'R' and s.firstName = 'Ella' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Y', 'Jasmine', t.id, 'Y', 'Jasmineneeekeekeke@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'Y' and s.firstName = 'Jasmine' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Y', 'Wyatt', t.id, 'Y', 'wyatt02379@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'Y' and s.firstName = 'Wyatt' and s.teamId = t.id);
...
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'U', 'Oluwase', t.id, 'Y', 'oluwaseunfunmiolapade@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'U' and s.firstName = 'Oluwase' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'P', 'Alexandra', t.id, 'Y', 'alexandraphoyt@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'P' and s.firstName = 'Alexandra' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'A', 'Dashora', t.id, 'Y', 'dashoraabhinav@gmail.com', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'A' and s.firstName = 'Dashora' and s.teamId = t.id);
...
-- 3926 MPArors
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Stout', 'Leo', t.id, 'Y', 'lstout28@moundsparkacademy.org ', 'N' from Team t where t.teamNumber = 3926 and not exists (select 1 from Scout s where s.lastName = 'Stout' and s.firstName = 'Leo' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Li', 'Hannabella', t.id, 'Y', 'hli27@moundsparkacademy.org ', 'N' from Team t where t.teamNumber = 3926 and not exists (select 1 from Scout s where s.lastName = 'Li' and s.firstName = 'Hannabella' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Beernink', 'Pim', t.id, 'Y', 'kbeernink29@moundsparkacademy.org ', 'N' from Team t where t.teamNumber = 3926 and not exists (select 1 from Scout s where s.lastName = 'Beernink' and s.firstName = 'Pim' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Hamilton', 'Spencer', t.id, 'Y', 'shamilton28@moundsparkacademy.org ', 'N' from Team t where t.teamNumber = 3926 and not exists (select 1 from Scout s where s.lastName = 'Hamilton' and s.firstName = 'Spencer' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Parkin', 'Elijah', t.id, 'Y', 'eparkin28@moundsparkacademy.org ', 'N' from Team t where t.teamNumber = 3926 and not exists (select 1 from Scout s where s.lastName = 'Parkin' and s.firstName = 'Elijah' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Powell', 'Gabe', t.id, 'Y', 'gpowell26@moundsparkacademy.org ', 'N' from Team t where t.teamNumber = 3926 and not exists (select 1 from Scout s where s.lastName = 'Powell' and s.firstName = 'Gabe' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Wrich', 'Jonah', t.id, 'Y', 'jwrich28@moundsparkacademy.org ', 'N' from Team t where t.teamNumber = 3926 and not exists (select 1 from Scout s where s.lastName = 'Wrich' and s.firstName = 'Jonah' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Huie', 'Alex', t.id, 'Y', 'ahuie26@moundsparkacademy.org ', 'N' from Team t where t.teamNumber = 3926 and not exists (select 1 from Scout s where s.lastName = 'Huie' and s.firstName = 'Alex' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Liao', 'Lilly', t.id, 'Y', 'lliao26@moundsparkacademy.org ', 'N' from Team t where t.teamNumber = 3926 and not exists (select 1 from Scout s where s.lastName = 'Liao' and s.firstName = 'Lilly' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Huie', 'Norah', t.id, 'Y', 'nhuie29@moundsparkacademy.org ', 'N' from Team t where t.teamNumber = 3926 and not exists (select 1 from Scout s where s.lastName = 'Huie' and s.firstName = 'Norah' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Maki', 'Mark', t.id, 'Y', 'omaki28@moundsparkacademy.org ', 'N' from Team t where t.teamNumber = 3926 and not exists (select 1 from Scout s where s.lastName = 'Maki' and s.firstName = 'Mark' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Hubert', 'Piper', t.id, 'Y', 'phubert26@moundsparkacademy.org ', 'N' from Team t where t.teamNumber = 3926 and not exists (select 1 from Scout s where s.lastName = 'Hubert' and s.firstName = 'Piper' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Gunes', 'Arda', t.id, 'Y', 'agunes28@moundsparkacademy.org ', 'N' from Team t where t.teamNumber = 3926 and not exists (select 1 from Scout s where s.lastName = 'Gunes' and s.firstName = 'Arda' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select '(Choose Scout)', '3926', t.id, 'Y', '3926@x.com', 'N' from Team t where t.teamNumber = 2926 and not exists (select 1 from Scout s where s.lastName = '(Choose Scout)' and s.firstName = '3926' and s.teamId = t.id);
update team set gameEventId = (select gameEventId from team where teamNumber = 6217) where teamNumber = 3926 and gameEventId is null

-- 6217 scouts from alliance partners, If needed.
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'z2526', 'Crimson Robotics', t.id, 'Y', '2526@y.com', 'Y' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'z2526' and s.firstName = 'Crimson Robotics' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'z3926', 'MPArors', t.id, 'Y', '3926@y.com', 'N' from Team t where t.teamNumber = 6217 and not exists (select 1 from Scout s where s.lastName = 'z3926' and s.firstName = 'MPArors' and s.teamId = t.id);
...
update Scout set isAdmin = 'Y' where isactive = 'Y' and isadmin = 'N' and emailaddress not in ('tba@tba.com', 'cfrobotics@cf.k12.mn.us', '9149@x.com') and emailaddress is not null;
...
insert into TeamSponsor select t.id, g.id, 'VFW Post 4452', 0, 20, 'Sponsors/VFW.jpg', 'https://cannonfallsvfw.com/', 30, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'American Legion Post 142', 0, 30, 'Sponsors/AmericanLegion.png', 'https://www.facebook.com/CannonFallsAmericanLegionPost142/', 30, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'Aliveo Military Museum', 0, 40, 'Sponsors/AliveoMilitaryMuseum.jpg', 'http://www.aliveomuseum.org/', 30, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'Gene Haas Foundation', 0, 50, 'Sponsors/GeneHaasFoundation.png', 'https://www.ghaasfoundation.org//', 30, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'Syngenta', 0, 55, 'Sponsors/Syngenta.jpg', 'https://www.syngenta-us.com/', 30, getdate(), null, null, 'Y' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'Donaldson Foundation', 0, 60, 'Sponsors/Donaldson.jpg', 'https://www.donaldson.com/en-us/', 30, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
--insert into TeamSponsor select t.id, g.id, 'Argosy Foundation', 0, 65, 'Sponsors/ArgosyFoundation_Logo_CMYK.jpg', 'https://www.argosyfnd.org/', 30, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'BTD Manufacturing', 0, 70, 'Sponsors/btd-mfg-logo.png', 'https://btdmfg.com/', 80, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'Cannon Falls Fire Department', 0, 80, 'Sponsors/CF Fire Department.jpg', 'https://www.cannonfallsmn.gov/fire', 30, getdate(), null, null, 'Y' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'Hernke Heating', 0, 90, 'Sponsors/hernkes heating and cooling.png', null, 30, getdate(), null, null, 'Y' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
--insert into TeamSponsor select t.id, g.id, 'BARR', 0, 95, 'Sponsors/BARRblue.png', 'https://barr.com/', 50, getdate(), null, null, 'Y' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'Flex Craft', 0, 100, 'Sponsors/flex craft logo.png', 'https://flex-craft.com/', 30, getdate(), null, null, 'Y' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'River Town Games', 0, 110, 'Sponsors/RiverTownGames.jpg', 'https://www.rivertowngames.com/', 30, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'Jim Althoff Real Estate', 0, 120, 'Sponsors/JimAlthoffRealEstate.jpeg', 'https://www.facebook.com/JimAlthoffRealtor/', 30, getdate(), null, null, 'Y' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'Quality One Woodworking', 0, 130, 'Sponsors/QualityOne.png', 'https://www.qualityonewoodwork.com/', 30, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'StarTech Computing', 0, 140, 'Sponsors/StarTech-logo.png', 'https://www.startech-comp.com/', 30, getdate(), null, null, 'Y' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'Milwaukee Tool', 0, 150, 'Sponsors/Milwaukee.jpg', 'https://www.milwaukeetool.com/', 30, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
--insert into TeamSponsor select t.id, g.id, 'Red Wing Area Manufacturers Association', 0, 153, 'Sponsors/RW Area Mfg Assoc.jpg', 'https://www.facebook.com/RWAreaMfrsAssoc/', 30, getdate(), null, null, 'Y' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
--insert into TeamSponsor select t.id, g.id, 'Auto Value', 0, 157, 'Sponsors/autovalueps.jpg', 'https://autovaluestores.com/ellsworth/', 30, getdate(), null, null, 'Y' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'Caseys', 0, 160, 'Sponsors/Casey_s.png', 'https://www.caseys.com/', 30, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
--insert into TeamSponsor select t.id, g.id, 'Swan and Bower', 0, 163, 'Sponsors/SwanAndBower.png', 'https://www.swanandbower.com/', 30, getdate(), null, null, 'Y' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
--insert into TeamSponsor select t.id, g.id, 'Brewster''s Bar & Grill', 0, 167, null, null, 30, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';
insert into TeamSponsor select t.id, g.id, 'Twist Solutions', 0, 170, null, null, 30, getdate(), null, null, 'N' from team t, game g where t.teamNumber = 6217 and g.name = 'Rebuilt';

update teamSponsor set maxWidthPercent = 90, width = null, height = null, sameLineAsPrevious = 'N' where gameid = (select id from game where name = 'Rebuilt') and sortOrder = 20 -- VFW
update teamSponsor set maxWidthPercent = 10 where gameid = (select id from game where name = 'Rebuilt') and sortOrder = 30 -- American Legion
update teamSponsor set maxWidthPercent = 40 where gameid = (select id from game where name = 'Rebuilt') and sortOrder = 40 -- Aliveo
update teamSponsor set maxWidthPercent = 15 where gameid = (select id from game where name = 'Rebuilt') and sortOrder = 50 -- Haas
update teamSponsor set maxWidthPercent = 90, width = null, height = null, sameLineAsPrevious = 'N' where gameid = (select id from game where name = 'Rebuilt') and sortOrder = 70 -- BTD
update teamSponsor set maxWidthPercent = 10 where gameid = (select id from game where name = 'Rebuilt') and sortOrder = 80 -- CFFD
update teamSponsor set maxWidthPercent = 15, sameLineAsPrevious = 'N' where gameid = (select id from game where name = 'Rebuilt') and sortOrder = 90 -- Hernke
update teamSponsor set maxWidthPercent = 20, sameLineAsPrevious = 'Y' where gameid = (select id from game where name = 'Rebuilt') and sortOrder = 100 -- FlexCraft
update teamSponsor set maxWidthPercent = 10 where gameid = (select id from game where name = 'Rebuilt') and sortOrder = 100 -- River Town Games
update teamSponsor set maxWidthPercent = 10 where gameid = (select id from game where name = 'Rebuilt') and sortOrder = 110 -- Jim ALthoff
update teamSponsor set maxWidthPercent = 20 where gameid = (select id from game where name = 'Rebuilt') and sortOrder = 140 -- StarTech
update teamSponsor set maxWidthPercent = 20 where gameid = (select id from game where name = 'Rebuilt') and sortOrder = 150 -- Milwaukee
update teamSponsor set maxWidthPercent = 10 where gameid = (select id from game where name = 'Rebuilt') and sortOrder = 160 -- Caseys
