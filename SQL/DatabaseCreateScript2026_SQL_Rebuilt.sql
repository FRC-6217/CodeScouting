...
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'K', 'Isa', t.id, 'Y', 'karim006@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'K' and s.firstName = 'Isa' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'R', 'Ella', t.id, 'Y', 'range006@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'R' and s.firstName = 'Ella' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'B', 'Ben', t.id, 'Y', 'becke030@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'B' and s.firstName = 'Ben' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'D', 'Arrow', t.id, 'Y', 'dudne002@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'D' and s.firstName = 'Arrow' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'N', 'Matthew', t.id, 'Y', 'newmat6952@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'N' and s.firstName = 'Matthew' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'H', 'Avery', t.id, 'Y', 'howe003@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'H' and s.firstName = 'Avery' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Y', 'Jasmine', t.id, 'Y', 'yang642@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'Y' and s.firstName = 'Jasmine' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'D', 'Vidyut', t.id, 'Y', 'deevid8270@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'D' and s.firstName = 'Vidyut' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'K', 'Kirill', t.id, 'Y', 'krakir5078@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'K' and s.firstName = 'Kirill' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'L', 'Ivan', t.id, 'Y', 'lin012@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'L' and s.firstName = 'Ivan' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'N', 'Travis', t.id, 'Y', 'ngutra0701@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'N' and s.firstName = 'Travis' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'Y', 'Wyatt', t.id, 'Y', 'yeage002@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'Y' and s.firstName = 'Wyatt' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'H', 'Charlie', t.id, 'Y', 'huynh036@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'H' and s.firstName = 'Charlie' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'L', 'Alayna', t.id, 'Y', 'lewis087@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'L' and s.firstName = 'Alayna' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'B', 'Audrey', t.id, 'Y', 'blaze002@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'B' and s.firstName = 'Audrey' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'J', 'Devin', t.id, 'Y', 'jones091@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'J' and s.firstName = 'Devin' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'K', 'Rachel', t.id, 'Y', 'kusie001@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'K' and s.firstName = 'Rachel' and s.teamId = t.id);
insert into Scout (lastName, firstName, teamId, isActive, emailAddress, isAdmin) select 'M', 'Zeynab', t.id, 'Y', 'mamzey3935@apps.district279.org', 'Y' from Team t where t.teamNumber = 2526 and not exists (select 1 from Scout s where s.lastName = 'M' and s.firstName = 'Zeynab' and s.teamId = t.id);
