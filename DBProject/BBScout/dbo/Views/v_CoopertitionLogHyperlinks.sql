...
CREATE view [dbo].[v_CoopertitionLogHyperlinks] as
select '<a href="coopertitionLog.php?coopertitionLogId=' + convert(varchar, cl.id) + '">' + format(cl.logDate, 'MM/dd/yy') + '</a>' logUrl
