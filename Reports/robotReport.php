...
$tsql = "select TeamNumber
    ...
    while ($row = sqlsrv_fetch_array($getResults, SQLSRV_FETCH_ASSOC)) {
		echo "<tr>";
			...
			if (isset($row['value1'])) echo "<td>" . number_format($row['value1'], 2) . "</td>"; else if (isset($row['textValue1'])) echo "<td>" . $row['textValue1']) . "</td>"; elseif ($cnt >= 1) echo "<td></td>";
			if (isset($row['value2'])) echo "<td>" . number_format($row['value2'], 2) . "</td>"; else if (isset($row['textValue2'])) echo "<td>" . $row['textValue2']) . "</td>"; elseif ($cnt >= 2) echo "<td></td>";
			if (isset($row['value3'])) echo "<td>" . number_format($row['value3'], 2) . "</td>"; else if (isset($row['textValue3'])) echo "<td>" . $row['textValue3']) . "</td>"; elseif ($cnt >= 3) echo "<td></td>";
			if (isset($row['value4'])) echo "<td>" . number_format($row['value4'], 2) . "</td>"; else if (isset($row['textValue4'])) echo "<td>" . $row['textValue4']) . "</td>"; elseif ($cnt >= 4) echo "<td></td>";
			if (isset($row['value5'])) echo "<td>" . number_format($row['value5'], 2) . "</td>"; else if (isset($row['textValue5'])) echo "<td>" . $row['textValue5']) . "</td>"; elseif ($cnt >= 5) echo "<td></td>";
			if (isset($row['value6'])) echo "<td>" . number_format($row['value6'], 2) . "</td>"; else if (isset($row['textValue6'])) echo "<td>" . $row['textValue6']) . "</td>"; elseif ($cnt >= 6) echo "<td></td>";
			if (isset($row['value7'])) echo "<td>" . number_format($row['value7'], 2) . "</td>"; else if (isset($row['textValue7'])) echo "<td>" . $row['textValue7']) . "</td>"; elseif ($cnt >= 7) echo "<td></td>";
			if (isset($row['value8'])) echo "<td>" . number_format($row['value8'], 2) . "</td>"; else if (isset($row['textValue8'])) echo "<td>" . $row['textValue8']) . "</td>"; elseif ($cnt >= 8) echo "<td></td>";
			if (isset($row['value9'])) echo "<td>" . number_format($row['value9'], 2) . "</td>"; else if (isset($row['textValue9'])) echo "<td>" . $row['textValue9']) . "</td>"; elseif ($cnt >= 9) echo "<td></td>";
			if (isset($row['value10'])) echo "<td>" . number_format($row['value10'], 2) . "</td>"; else if (isset($row['textValue10'])) echo "<td>" . $row['textValue10']) . "</td>"; elseif ($cnt >= 10) echo "<td></td>";
			if (isset($row['value11'])) echo "<td>" . number_format($row['value11'], 2) . "</td>"; else if (isset($row['textValue11'])) echo "<td>" . $row['textValue11']) . "</td>"; elseif ($cnt >= 11) echo "<td></td>";
			if (isset($row['value12'])) echo "<td>" . number_format($row['value12'], 2) . "</td>"; else if (isset($row['textValue12'])) echo "<td>" . $row['textValue12']) . "</td>"; elseif ($cnt >= 12) echo "<td></td>";
			if (isset($row['value13'])) echo "<td>" . number_format($row['value13'], 2) . "</td>"; else if (isset($row['textValue13'])) echo "<td>" . $row['textValue13']) . "</td>"; elseif ($cnt >= 13) echo "<td></td>";
			if (isset($row['value14'])) echo "<td>" . number_format($row['value14'], 2) . "</td>"; else if (isset($row['textValue14'])) echo "<td>" . $row['textValue14']) . "</td>"; elseif ($cnt >= 14) echo "<td></td>";
			if (isset($row['value15'])) echo "<td>" . number_format($row['value15'], 2) . "</td>"; else if (isset($row['textValue15'])) echo "<td>" . $row['textValue15']) . "</td>"; elseif ($cnt >= 15) echo "<td></td>";
			/*
