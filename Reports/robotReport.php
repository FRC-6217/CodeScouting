...
$tsql = "select TeamNumber
    ...
    while ($row = sqlsrv_fetch_array($getResults, SQLSRV_FETCH_ASSOC)) {
		echo "<tr>";
			...
			if (isset($row['value1'])) echo "<td>" . number_format($row['value1'], 2) . "</td>"; elseif (isset($row['textValue1'])) echo "<td>1</td>"; elseif ($cnt >= 1) echo "<td></td>";
			if (isset($row['value2'])) echo "<td>" . number_format($row['value2'], 2) . "</td>"; elseif (isset($row['textValue2'])) echo "<td>2</td>"; elseif ($cnt >= 2) echo "<td></td>";
			if (isset($row['value3'])) echo "<td>" . number_format($row['value3'], 2) . "</td>"; elseif (isset($row['textValue3'])) echo "<td>3</td>"; elseif ($cnt >= 3) echo "<td></td>";
			if (isset($row['value4'])) echo "<td>" . number_format($row['value4'], 2) . "</td>"; elseif (isset($row['textValue4'])) echo "<td>4</td>"; elseif ($cnt >= 4) echo "<td></td>";
			if (isset($row['value5'])) echo "<td>" . number_format($row['value5'], 2) . "</td>"; elseif (isset($row['textValue5'])) echo "<td>5</td>"; elseif ($cnt >= 5) echo "<td></td>";
			if (isset($row['value6'])) echo "<td>" . number_format($row['value6'], 2) . "</td>"; elseif (isset($row['textValue6'])) echo "<td>6</td>"; elseif ($cnt >= 6) echo "<td></td>";
			if (isset($row['value7'])) echo "<td>" . number_format($row['value7'], 2) . "</td>"; elseif (isset($row['textValue7'])) echo "<td>7</td>"; elseif ($cnt >= 7) echo "<td></td>";
			...
			if (isset($row['value12'])) echo "<td>" . number_format($row['value12'], 2) . "</td>"; elseif (isset($row['textValue12'])) echo "<td>12</td>"; elseif ($cnt >= 12) echo "<td></td>";
